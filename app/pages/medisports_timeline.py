...
def render(data: dict):
    ...
    st.markdown(
        ...
        .timeline-month-events { --timeline-center-lane:6.6rem; --timeline-connector:5.45rem; position:relative; display:grid; grid-template-columns:minmax(0, 1fr) var(--timeline-center-lane) minmax(0, 1fr); row-gap:.44rem; column-gap:0; padding:0 .25rem; }
        ...
        .timeline-event-shell { position:relative; min-width:0; width:100%; max-width:44rem; }
        .timeline-event-shell.lane-left { grid-column:1; justify-self:end; min-width:min(100%, 23.5rem); padding-right:1.05rem; }
        .timeline-event-shell.lane-right { grid-column:3; justify-self:start; min-width:min(100%, 23.5rem); padding-left:1.05rem; margin-top:2.35rem; }
        .timeline-event-shell.width-expanded,
        .timeline-event-shell.width-regular,
        .timeline-event-shell.width-compact { width:100%; }
        .timeline-event-shell::before { content:""; position:absolute; top:1.2rem; height:2px; z-index:1; }
        .timeline-event-shell.lane-left::before { right:calc(var(--timeline-connector) * -1); width:var(--timeline-connector); background:linear-gradient(90deg, rgba(118,145,170,.14) 0%, rgba(118,145,170,.86) 82%, rgba(118,145,170,.94) 100%); }
        .timeline-event-shell.lane-right::before { left:calc(var(--timeline-connector) * -1); width:var(--timeline-connector); background:linear-gradient(90deg, rgba(118,145,170,.94) 0%, rgba(118,145,170,.84) 20%, rgba(118,145,170,.16) 100%); }
        ...
        .timeline-event-shell.lane-left::after { right:calc((var(--timeline-connector) + .1rem) * -1); border-right:2px solid rgba(118,145,170,.45); border-top-right-radius:.88rem; }
        .timeline-event-shell.lane-right::after { left:calc((var(--timeline-connector) + .1rem) * -1); border-left:2px solid rgba(118,145,170,.45); border-top-left-radius:.88rem; }
        ...
        .timeline-event-shell.lane-left .timeline-event-node { right:calc((var(--timeline-connector) + .45rem) * -1); }
        .timeline-event-shell.lane-right .timeline-event-node { left:calc((var(--timeline-connector) + .45rem) * -1); }
        ...
        .timeline-main { min-width:0; display:grid; grid-template-columns:minmax(0, 1fr) minmax(84px, 94px); gap:.48rem; align-items:start; }
        .timeline-event-shell.lane-left .timeline-main { grid-template-columns:minmax(84px, 94px) minmax(0, 1fr); }
        .timeline-event-shell.lane-left .timeline-copy { order:2; }
        .timeline-event-shell.lane-left .timeline-media { order:1; }
        .timeline-event-shell.width-compact .timeline-main { grid-template-columns:minmax(0, 1fr) minmax(78px, 82px); }
        .timeline-event-shell.lane-left.width-compact .timeline-main { grid-template-columns:minmax(78px, 82px) minmax(0, 1fr); }
        .timeline-event-shell.width-expanded .timeline-main { grid-template-columns:minmax(0, 1fr) minmax(96px, 108px); }
        .timeline-event-shell.lane-left.width-expanded .timeline-main { grid-template-columns:minmax(96px, 108px) minmax(0, 1fr); }
