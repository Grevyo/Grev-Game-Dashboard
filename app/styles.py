...
def inject_styles(theme_name: str = "Dark"):
    ...
    .grevscore-dial-wrap {{
      ...
      background: linear-gradient(180deg, color-mix(in srgb, var(--surface) 78%, #fff 22%), color-mix(in srgb, var(--surface) 96%, #000 4%));
    }}
    .grevscore-dial {{
      width: 172px;
      height: 94px;
      ...
      overflow: hidden;
      background:
        conic-gradient(from 180deg, color-mix(in srgb, var(--good) 86%, #fff 14%) 0deg, color-mix(in srgb, var(--mid) 84%, #fff 16%) 88deg, color-mix(in srgb, var(--poor) 86%, #fff 14%) 132deg, color-mix(in srgb, var(--bad) 82%, #fff 18%) 180deg),
        color-mix(in srgb, var(--surface) 82%, #fff 18%);
      border: 1px solid color-mix(in srgb, var(--accent) 28%, var(--border));
      box-shadow: inset 0 -6px 14px rgba(0,0,0,0.2);
    }}
    .grevscore-dial::after {{
      content:"";
      position:absolute;
      inset: 12px;
    ...
    .grevscore-dial::before {{
      ...
      transform: translateX(-50%) rotate(calc(var(--dial-angle) - 90deg));
      background: linear-gradient(180deg, color-mix(in srgb, var(--accent) 82%, #fff 18%), color-mix(in srgb, var(--accent) 56%, #fff 44%));
      border-radius: 999px;
    ...
    .grevscore-dial-caption {{
      font-size: 10px;
      letter-spacing: 0.04em;
      text-transform: uppercase;
      color: var(--muted);
    }}
    .grevscore-dial-scale {{
      width: 172px;
      display:flex;
